...
- [ ] исправить с потоками (сдеалть один STL поток (с синхронизацией на одной переменной) ), т.к. второй не нужен в целом.
- [ ] убрать лишний код в series/chart.
- [ ] fft план сделать один (не надо их создавать в цикле, потому что это операция наклалдная).
